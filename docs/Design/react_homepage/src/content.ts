...
export const heroWeeks: { start: number; bars: { kind: 'garde' | 'indispo'; who: string; from: number; to: number }[] }[] = [
  { start: 2,  bars: [{ kind: 'indispo', who: 'CH', from: 2, to: 4 }, { kind: 'garde', who: 'JV', from: 5, to: 7 }] },
  { start: 9,  bars: [{ kind: 'indispo', who: 'SB', from: 1, to: 2 }, { kind: 'garde', who: 'ML', from: 5, to: 7 }] },
  { start: 16, bars: [{ kind: 'garde', who: 'CH', from: 1, to: 1 }, { kind: 'indispo', who: 'AO', from: 3, to: 7 }] },
  { start: 23, bars: [{ kind: 'indispo', who: 'JV', from: 1, to: 1 }, { kind: 'garde', who: 'SB', from: 5, to: 7 }] },
];
...
export const selectionPeriods: [number, number][] = [[10, 12], [16, 16], [19, 22]];
...
export const statTabs = [
  { id: 'periode', label: 'Cette période', note: 'Novembre 2026 · gardes affectées, comptées sur leur jour de la semaine.' },
  { id: 'cumul', label: 'Cumul du planning', note: 'Ensemble du planning · calculé à partir des affectations réelles.' },
] as const;

export const engineSteps = [
  { n: '1', title: 'Éligibilité', body: `Qui peut réellement assurer cette garde${NB}?`, tone: 'ink' },
  { n: '2', title: 'Contraintes', body: 'Indisponibilités, conflits de garde et règles de repos.', tone: 'red' },
  { n: '3', title: 'Répartition', body: 'Recherche d’une solution cohérente à l’échelle du planning.', tone: 'green' },
] as const;
...
export const spaces = [
  { title: 'Pour les membres', tone: 'red',
  ...
  { title: 'Pour le responsable du planning', tone: 'blue',
  ...
  { title: 'Pour toute l’équipe', tone: 'green',
