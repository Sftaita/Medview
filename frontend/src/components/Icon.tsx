/**
 * Small inline icon set (Lucide outline paths, 24×24 grid). Kept in-repo to
 * avoid a dependency for ~20 glyphs; the markup below is static and trusted.
 */
const PATHS = {
  ...
  calendarX:
    '<path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path><path d="m14 14-4 4"></path><path d="m10 14 4 4"></path>',
  ...
  check: '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><path d="m9 11 3 3L22 4"></path>',
  pencil:
